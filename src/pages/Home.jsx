...
export default function Home() {
    return (
        ...
        <div className="max-w-6xl w-full flex flex-col-reverse lg:flex-row items-center lg:items-start justify-between gap-8 md:gap-10 lg:gap-16 mt-8 lg:mt-0 lg:pt-20">
            <HeroContent />
            <HeroAvatar />
        </div>
