...
return (
        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-12 py-4 flex justify-between items-center">
            ...
            <a href="#" className="font-pixel text-[#00e5ff] text-[10px] md:text-xs tracking-widest hover:text-white transition-colors drop-shadow-[0_0_5px_rgba(0,229,255,0.5)]">
                DEV_LOG<span className="animate-blink">_</span>
            </a>
            ...
            <li><a href="#" className="hover:text-[#00e5ff] hover:drop-shadow-[0_0_8px_#00e5ff] transition-all">EXPERIENCES</a></li>
            ...
            <li className="relative group py-2">
                ...
                <a href="#" className="px-4 py-3 text-sm hover:bg-[#00e5ff]/20 hover:text-[#00e5ff] hover:pl-6 transition-all border-b border-[#6b7280]/20 relative group/item">
                    <span className="absolute left-2 opacity-0 group-hover/item:opacity-100 text-[#00e5ff] transition-opacity">►</span> Game Projects
                </a>
                <a href="#" className="px-4 py-3 text-sm hover:bg-[#00e5ff]/20 hover:text-[#00e5ff] hover:pl-6 transition-all relative group/item">
                    <span className="absolute left-2 opacity-0 group-hover/item:opacity-100 text-[#00e5ff] transition-opacity">►</span> Other Projects
                </a>
                </div>
            </li>

            <li><a href="#" className="hover:text-[#00e5ff] hover:drop-shadow-[0_0_8px_#00e5ff] transition-all">CERTIFICATE</a></li>
            <li><a href="#" className="hover:text-[#00e5ff] hover:drop-shadow-[0_0_8px_#00e5ff] transition-all">BLOG</a></li>
            </ul>
        ...
        {isMobileMenuOpen && (
            ...
            <ul className="flex flex-col p-4 space-y-4">
                ...
                <li><a href="#" className="block hover:text-[#00e5ff] transition-colors">{">"} EXPERIENCES</a></li>
                <li className="pt-2">
                <span className="block text-[#ff0055] mb-2">{">"} PROJECTS :</span>
                <ul className="pl-4 border-l border-[#00e5ff]/30 space-y-3">
                    <li><a href="#" className="block hover:text-[#00e5ff] transition-colors">├─ Game Projects</a></li>
                    <li><a href="#" className="block hover:text-[#00e5ff] transition-colors">└─ Other Projects</a></li>
                </ul>
                </li>
                <li className="pt-2"><a href="#" className="block hover:text-[#00e5ff] transition-colors">{">"} CERTIFICATE</a></li>
                <li><a href="#" className="block hover:text-[#00e5ff] transition-colors">{">"} BLOG</a></li>
            </ul>
            </div>
        )}
        </nav>
