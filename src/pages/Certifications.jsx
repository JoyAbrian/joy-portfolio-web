        ...
        <main className="container mx-auto px-4 sm:px-6 md:px-12 relative z-10 pt-28 pb-20">
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {certifications2.map((cert) => (
                    <div
                        key={cert.id}
                        className="group relative flex flex-col h-full border border-[#6b7280]/30 bg-[#0a0a0f] p-4 md:p-5 transition-all duration-300 hover:border-[#ffb100] hover:shadow-[0_0_20px_rgba(255,177,0,0.15)] overflow-hidden"
                    >
                        ...
                        <div className="flex flex-col h-full relative z-10">
                            ...
                            <div className="flex items-start gap-4 mb-4">
                                <div className="shrink-0 w-12 h-12 bg-gray-900 border border-[#6b7280]/50 p-1 group-hover:border-[#ffb100] transition-colors duration-300 flex items-center justify-center">
                                    <img
                                        src={cert.logo}
                                ...
                                <div>
                                    <h2 className="font-pixel text-xs md:text-sm text-white mb-1 group-hover:text-[#ffb100] transition-colors duration-300 leading-tight line-clamp-2">
                                        {cert.title}
                                    </h2>
                                    <p className="font-mono text-[#e0e0e0] font-bold text-xs">
                                        {cert.issuer}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex-1 flex flex-col">
                                ...
                                {cert.credentialId && (
                                    <p className="font-mono text-[#6b7280] text-[10px] md:text-xs mb-3">
                                        ID: <span className="text-[#e0e0e0] break-all">{cert.credentialId}</span>
                                    </p>
                                )}
                                ...
                                <div className="mt-auto pt-2">
                                    {cert.credentialUrl && (
                                        <a
                                            ...
                                            className="inline-flex items-center gap-1 border border-[#6b7280] group-hover:border-[#ffb100] text-[#6b7280] group-hover:text-[#ffb100] font-mono text-[10px] px-3 py-1.5 hover:bg-[#ffb100] hover:text-[#0a0a0f]! transition-all duration-300 w-fit"
                                        >
                            ...
                            {cert.docs && cert.docs.length > 0 && (
                                <div className="mt-4 pt-3 border-t border-[#6b7280]/20">
                                    <h3 className="font-pixel text-[8px] md:text-[10px] text-[#ffb100] mb-2 flex items-center gap-2">
                                        <span className="animate-pulse">★</span> ATTACHMENTS:
                                    </h3>
                                    <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
                                        {cert.docs.map((doc, i) => (
                                            ...
                                            >
                                                <div className="w-20 h-14 md:w-24 md:h-16 border border-[#6b7280]/40 overflow-hidden relative bg-gray-900">
                                                    ...
                                                    />
                                                    <div className="absolute bottom-0 left-0 right-0 bg-black/80 border-t border-[#ffb100]/50 p-0.5 translate-y-full group-hover/doc:translate-y-0 transition-transform duration-300 z-20">
                                                        <p className="font-mono text-[7px] text-white truncate text-center">
                                                            {doc.title}
                                                        </p>
                                                    </div>
                                                </div>
                            ...
                            <div className="absolute top-0 right-0 opacity-10 group-hover:opacity-20 transition-opacity pointer-events-none hidden sm:block">
                                <div className="w-16 h-16 border-2 border-[#ffb100] rounded-full flex items-center justify-center rotate-12 -mt-2 -mr-2">
                                    <span className="font-pixel text-[#ffb100] text-[7px] text-center">VERIFIED<br/>ASSET</span>
                                </div>
                            </div>
